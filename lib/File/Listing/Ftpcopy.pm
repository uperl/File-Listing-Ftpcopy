...
drop in replacement for the parse_dir function from L<File::Listing>
...
not be faster, although probably unnoticable unless you are parsing a recursive
...
domain, but there was one dependant C source file which was licensed under GPL 2, so I
